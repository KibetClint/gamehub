    ...
    <div className="min-h-screen flex flex-col">
      {/* Main Content */}
        <main className="flex-1">
            ...
            <section className=" py-16 bg-grey-500 text-white flex flex-col md:flex-row items-center gap-6 md:gap-12 px-4" 
                style={{ backgroundImage: 'url(/src/assets/images/P2.webp)', 
                backgroundSize: 'cover', 
                backgroundPosition: 'center' }}>
                {/* Pool Insights */}
                <div className="h-[60vh] bg-amber-200 flex-1 flex flex-col items-center justify-center text-center"
                ...
                {/* Chess Insights */}
                <div className="bg-red-200 h-[60vh] flex-1 flex flex-col items-center justify-center text-center"
